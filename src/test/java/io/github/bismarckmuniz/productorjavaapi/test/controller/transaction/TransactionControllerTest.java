package io.github.bismarckmuniz.productorjavaapi.test.controller.transaction;
...
public class TransactionControllerTest {
	...
	private static final String URL = "/productor/v1/transactions";
	...
	public void testSave() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.post(URL)
			.content(getJsonPayload(ID, NSU, AUTH, productorApiUtil.
	...
	public void testSaveInvalidTransaction() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.post(URL)
				.content(getJsonPayload(ID, null, AUTH, productorApiUtil.
				 getLocalDateTimeFromString(TRANSACTION_DATE.concat("Z")), VALUE, TYPE))
				.contentType(MediaType.APPLICATION_JSON)
				.accept(MediaType.APPLICATION_JSON)
				.headers(headers))
	...
	private Transaction getMockTransaction() throws ParseException {
		...
		Transaction transaction = new Transaction(ID, NSU, AUTH,
			productorApiUtil.getLocalDateTimeFromString(TRANSACTION_DATE.concat("Z")), 
			VALUE, TYPE);
