...
public class SwaggerConfiguration {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("io.github.bismarckmuniz.productorjavaapi.controller"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("productor Java API")
				.description("productor Java API - Endpoint's documentation").version(releaseVersion.concat("_").concat(apiVersion))
				.build();
	}
